...
export const metadata: Metadata = { title: "Companionship & Event Planning", description: "Personal companionship and thoughtfully planned group experiences, beginning with a complimentary 30-minute consultation." };
