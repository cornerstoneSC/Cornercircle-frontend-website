...
export default function ServicesComingSoon() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    setError("");
    try {
      await subscribeNewsletter(email, "", "/services");
      setSubmitted(true);
      setEmail("");
    } catch (reason) {
      setError(
  ...
  return (
    <section className="w-full bg-[#faf8f3] px-6 py-16 md:px-10 md:py-24">
      <div
        className="
          mx-auto
          max-w-6xl
      ...
      >
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <h2
            ...
            "
          >
            Our services page is on its way!
          </h2>
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="mt-2 max-w-sm text-sm leading-6 text-[#716B75]">
                  ...
                  and be notified as soon as this page
                  <br className="hidden sm:block" />
                  goes live.
                </p>
              </div>
